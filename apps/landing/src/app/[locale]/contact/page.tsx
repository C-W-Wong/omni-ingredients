        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="animate-on-scroll scale-in stagger-3 bg-white rounded-2xl p-6 border border-neutral-200 shadow-sm hover:shadow-md transition group">
              ...
              <h3 className="font-semibold text-neutral-900 mb-1">{t("info.phone")}</h3>
              <a
                href="tel:+19386669996"
                className="text-orange-600 hover:text-orange-700 transition"
              >
                (938) 666-9996
              </a>
            ...
            {/* Hours Card */}
            <div className="animate-on-scroll scale-in stagger-5 bg-white rounded-2xl p-6 border border-neutral-200 shadow-sm hover:shadow-md transition group">
              <div className="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-orange-200 transition">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            {/* Response Time Card */}
            <div className="animate-on-scroll scale-in stagger-6 bg-gradient-to-br from-orange-500 to-amber-500 rounded-2xl p-6 text-white">
