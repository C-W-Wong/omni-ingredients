...
const getIconComponent = (iconName: string) => {
  switch (iconName) {
    ...
    case "message-square": return <MessageIcon />;
        ...
        <div className="relative z-10 flex h-full max-w-7xl mx-auto px-4 sm:px-6 items-end pb-16 sm:pb-24">
          <div className="max-w-3xl text-white hero-content">
            ...
            <h1 className="mt-4 sm:mt-6 text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight font-playfair leading-[1.1] animate-on-scroll text-reveal stagger-2">
              Reliable Functional Ingredients, Built for Scale
            </h1>
            <p className="text-base sm:text-lg md:text-xl opacity-90 mt-6 max-w-2xl leading-relaxed animate-on-scroll text-reveal stagger-3">
              Your trusted partner for high-quality nutraceutical ingredients. U.S.-based operations, global sourcing expertise, and supply chain you can count on.
            </p>
        ...
        <div className="max-w-7xl mx-auto py-12 sm:py-16 px-4 sm:px-6">
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-16">
            {trustStats.map((stat, index) => (
              <div
                key={stat.label}
                className={`text-center animate-on-scroll blur-slide stagger-${index + 1}`}
              >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="mt-4 text-neutral-600 max-w-2xl mx-auto animate-on-scroll text-reveal stagger-3">
              Sourcing ingredients internationally comes with real obstacles. We built Omni to solve them.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {painPoints.map((point, index) => (
              ...
              >
                ...
                <h3 className="font-semibold text-lg text-[#2A2118]">{point.title}</h3>
                <p className="mt-3 text-sm text-neutral-600 leading-relaxed">{point.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="mt-6 text-neutral-600 text-lg leading-relaxed animate-on-scroll text-reveal stagger-3">
                We combine international sourcing expertise with U.S.-based operations to deliver ingredients reliably, transparently, and at scale.
              </p>
              ...
              <div className="mt-8 space-y-5">
                {solutions.map((solution, index) => (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-semibold text-[#2A2118]">{solution.title}</h4>
                      <p className="text-sm text-neutral-600 mt-1">{solution.description}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="relative animate-on-scroll slide-right stagger-2">
              ...
              <div className="absolute -bottom-6 -left-6 bg-[#2A2118] text-white p-6 rounded-xl shadow-xl animate-on-scroll scale-in stagger-6">
                <p className="text-3xl font-bold font-playfair">24hr</p>
                <p className="text-sm opacity-80 mt-1">Quote Response</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-6 text-neutral-300 text-lg leading-relaxed animate-on-scroll text-reveal stagger-3">
                Omni Ingredients is a U.S.-based solutions company specializing in the sourcing, distribution, and commercialization of high-quality functional ingredients for the nutraceutical, food & beverage, and health industries.
              </p>
              <p className="mt-4 text-neutral-400 leading-relaxed animate-on-scroll text-reveal stagger-4">
                Backed by R&D capabilities from our parent group, we bring technical depth and supply chain expertise to every partnership.
              </p>
      ...
      <section className="relative py-16 sm:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="mt-4 text-neutral-600 max-w-2xl mx-auto animate-on-scroll text-reveal stagger-3">
              From single-ingredient sourcing to custom premix solutions, we support the full spectrum of functional nutrition.
            </p>
          </div>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                ...
                <p className="mt-2 text-neutral-600 max-w-xl">
                  Beyond single ingredients, we offer pre-blended formulation support for complete product development.
                </p>
              </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="mt-4 text-neutral-300 max-w-2xl mx-auto animate-on-scroll text-reveal stagger-3">
              Quality and compliance are fundamental to our operations. We work closely with qualified partners to ensure all products meet U.S. regulatory standards.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {qualityPillars.map((pillar, index) => (
              ...
              >
                ...
                <p className="mt-3 text-sm text-neutral-300 leading-relaxed">{pillar.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-16 sm:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-neutral-600 max-w-2xl mx-auto animate-on-scroll text-reveal stagger-3">
              From emerging brands to established manufacturers, we partner with companies across the health and wellness spectrum.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {warehouseLocations.map((location, index) => (
                ...
                >
                  ...
                  <h4 className="text-lg font-semibold text-[#2A2118] mt-1">{location.city}</h4>
                  <p className="text-sm text-neutral-600 mt-2">{location.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 animate-on-scroll blur-slide">
            ...
            <p className="mt-4 text-lg opacity-90 max-w-2xl mx-auto animate-on-scroll text-reveal stagger-2">
              Whether you're a manufacturer seeking North American market access or a brand looking for reliable ingredient solutions, we're here to help.
            </p>
          </div>
          ...
          <div className="mt-12 text-center text-white/80 space-y-2 animate-on-scroll fade-in">
            ...
            <p>
              <strong className="text-white">Hours:</strong> Monday – Friday, 08:30 am – 05:00 pm EST
            </p>
            <p>
